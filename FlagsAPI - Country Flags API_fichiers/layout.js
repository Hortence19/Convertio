...
var _noframeworkWaypoints = __webpack_require__(39);

var _noframeworkWaypoints2 = _interopRequireDefault(_noframeworkWaypoints);

var _slickCarousel = __webpack_require__(38);
...
// BURGER
(0, _jquery2.default)('.material--burger').on('click', function () {
    (0, _jquery2.default)(this).toggleClass('material--arrow');
});
(0, _jquery2.default)(".navigation--button, .material--burger").click(function () {
    (0, _jquery2.default)(".menu").toggleClass("menu_visible");
    return false;
});
// END BURGER
...
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.first_slick').slick({
        dots: true,
        arrows: true,
        autoplay: true,
        autoplaySpeed: 6000
...
// $(".item_country").hover(function(){
//     $(".item_country img").attr("src", function(index, attr){
//         return attr.replace("/flat/", "/shiny/");
//     });
// }, function(){
//     $(".item_country img").attr("src", function(index, attr){
//         return attr.replace("/shiny/", "/flat/");
//     });
// });


(0, _jquery2.default)("document").ready(function () {
    (0, _jquery2.default)(".item_country").mouseenter(function () {
        (0, _jquery2.default)(this).find('img').attr('src', function (index, attr) {
            return attr.replace("/flat/", "/shiny/");
        });
    });
    (0, _jquery2.default)(".item_country").mouseleave(function () {
        (0, _jquery2.default)(this).find('img').attr('src', function (index, attr) {
            return attr.replace("/shiny/", "/flat/");
        });
    });
...
// waypoints
var waypoint = new Waypoint({
    element: document.getElementById('waypoints_class'),
    handler: function handler() {
        console.log('Basic waypoint triggered');
        (0, _jquery2.default)("#waypoints_class").addClass("bg_primary");
    }
});
...
/*
     FILE ARCHIVED ON 13:08:55 Feb 13, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:09:19 Dec 03, 2021.
...
/*
playback timings (ms):
  captures_list: 193.034
  exclusion.robots: 0.373
  exclusion.robots.policy: 0.355
  cdx.remote: 0.159
  esindex: 0.018
  LoadShardBlock: 156.441 (3)
  PetaboxLoader3.datanode: 188.221 (4)
  CDXLines.iter: 16.997 (3)
  load_resource: 269.481
  PetaboxLoader3.resolve: 167.527
*/